...
//_______________________________One Answer Question_____________________________________
...
class OneAnswerQuestion : public Question {
  ...
  public:
    ...
    OneAnswerQuestion(const std::vector<std::string> &Answers, const std::string &CorrectAnswer, std::string Formulation) 
      : Answers(Answers), CorrectAnswer(CorrectAnswer), Formulation(Formulation) {};
    ...
    void toJson(nlohmann::json &J) const override {
      J = nlohmann::json{{"Formulation", Formulation}, {"Answers", Answers}, {"CorrectAnswer", CorrectAnswer}};
    }
...
//__________________________________Answer Paper_________________________________________
